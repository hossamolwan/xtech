$(function () {
	...
	$('#navigation a').on('click', function(){
  	...
  	$('.page').not('#contact-page').find('.btn,.scrolldown').on('click',function(e){
  		e.preventDefault();
...
Agency : XTECH
URL : HTTP://WWW.XTRCH.GA/
E-mail : CONTACT@XTECH.GA/
---------
Designer : HOSSAM OLWAN
Front-end Dev. : HOSSAM OLWAN
--------- 
Client : XTECH
Website : HTTP://WWW.XTECH.GA/
---------
Date : 20.12.2019
Last Edit : 20.12.2019  
City : CAIRO
Country : EGYPT
---------
